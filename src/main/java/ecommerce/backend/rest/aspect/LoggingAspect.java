...
public class LoggingAspect {
	...
	public void logMethodCallBefore(JoinPoint joinPoint) {
		...
		StringBuilder message = new StringBuilder("Before Method:" + joinPoint.getSignature().getName());
	...
	public void logMethodCallAfter(JoinPoint joinPoint, Object returnValue) {
		...
		StringBuilder message = new StringBuilder("After Method:" + joinPoint.getSignature().getName());
		Object[] args = joinPoint.getArgs();
	...
	public Object logMethodCallAround(ProceedingJoinPoint joinPoint) throws Throwable {
		...
		StringBuilder message = new StringBuilder("Around Method:" + joinPoint.getSignature().getName());
